defmodule UtilityWeb.Icon do
  ...
  def caret(assigns) do
    ~H"""
    <svg class={@class} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" {@rest}>
  ...
  def diff(assigns) do
    ~H"""
    <svg class={@class} stroke="none" fill="currentColor" viewBox="0 0 896 1024">
  ...
  def bluesky(assigns) do
    ~H"""
    <svg class={@class} fill="currentColor" role="img" aria-label="Bluesky logo" viewBox="0 0 600 530" xmlns="http://www.w3.org/2000/svg">
  ...
  def github(assigns) do
    ~H"""
    <svg class={@class} fill="currentcolor" aria-label="GitHub logo" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
